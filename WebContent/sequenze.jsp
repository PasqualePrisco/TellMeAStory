	...
	<div id="wrapper">
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="card-header" id="head"> Sequenze  <span class="floatR myMargin" title="Elimina un Album"><a  id="buttonShake" data-toggle="modal" href="#" onclick="setAction('add')" ><i class="fas fa-minus-square my-fa"></i></a></span><span title="Aggiungi un album" class="floatR"><a  data-toggle="modal" href="#popup1" onclick="setAction('add')" ><i class="fas fa-plus-square my-fa"></i></a></span></div>
