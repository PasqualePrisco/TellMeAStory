			...
			<div class="container-fluid">
				...
				<div class="card mb-3 demo-3">
					<div class="card-header" id="head">
						Storie <span class="floatR myMargin" title="Elimina un Album">
						<a id="buttonShake" data-toggle="modal" href="#" onclick="setAction('add')">
						<i class="fas fa-minus-square my-fa"></i></a></span>
						<span title="Aggiungi un album" class="floatR"><a data-toggle="modal" href="#popup1" onclick="setAction('add')"><i
								class="fas fa-plus-square my-fa"></i></a></span>
					</div>
						...
						<li value=<%= bean.getId()%>>
							<figure class="effect-zoe">
								...
								<figcaption>
									<h3><%=bean.getNome()%></h3>
									<a class="linkButton"
										href="addAlbum?action=getAlbum&param=<%=bean.getId()%>">Gestisci</a>
									<a class="linkButton modifyButton" data-toggle="modal"
										data-target="#popup1"
										onclick="setAction('modifyAlbum'), setTarget(<%=bean.getId()%>)">Modifica</a>
								</figcaption>
							</figure>
						</li>
						<%
					...
					<div
						...
						<form class="txtCenter" method="post" action="addAlbum"
							...
							<div class="form-group">
								...
								<input type="hidden" id="act" name="action" value="modifyAlbum">
								<input class="form-control" name="nome" type="text"
									maxlength="20" required placeholder="Nome"> <input
